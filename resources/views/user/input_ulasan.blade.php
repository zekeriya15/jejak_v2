        ...
        <div class="container-lg">
            ...
            <div class="row justify-content-center my-5">
                ...
                <div class="col-lg-6 bg-secondary-subtle p-4 rounded">
                    <form action="{{ route('submit.ulasan', ['tripId' => $trip->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Form fields here -->
                        ...
                        <div class="form-floating my-2">
                            <textarea name="ulasan" class="form-control" id="ulasan" style="height: 140px;"></textarea>
